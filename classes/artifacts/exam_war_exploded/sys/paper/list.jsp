		...
		<div class="container-fluid">
			<div class="row-fluid">
				<form class="form-inline" method="post"
					...
					<input class="input-xlarge" placeholder="试卷名..." name="pname"
						type="text" value="${param.pname}">
					<input class="btn icon-search" type="submit" value="查询" />
					<a class="btn btn-primary"
						href="<%=basePath%>sys/paper?cmd=showAddForm"> <i
						class="icon-plus"></i> 新增 </a>
					<a class="btn btn-info"
						href="<%=basePath%>sys/paper?cmd=gradeEssays"> <i
						class="icon-pencil"></i> 简答题评分 </a>
				</form>
							...
							<c:forEach items="${pager.list}" var="item">
								<tr>
									...
									<td>
										...
										<a href="javascript:void(0);" onclick="del1('${item.pname}')">删除试题</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
